...
function RavelPot(json) {
	...
	this.addControlToPage = function() {
		...
		if (position = "absolute") {
			document.getElementById("pot-" + this.ref + "-wrapper").style["position"] = "absolute";
			document.getElementById("pot-" + this.ref + "-wrapper").style["top"] = this.y + "px";
			document.getElementById("pot-" + this.ref + "-wrapper").style["left"] = this.x + "px";
			document.getElementById("pot-" + this.ref + "-wrapper").style["display"] = "block";
		}
		
		// fudge factor is a hack to correct for existing images
		let fudgeX = -8;
		let fudgeY = -7;
		document.getElementById("pot-" + this.ref).style["width"] = this.w;
		document.getElementById("pot-" + this.ref).style["height"] = this.h;
		
		document.getElementById("pot-touch-point-" + this.ref).style["width"] = this.touchW;
		document.getElementById("pot-touch-point-" + this.ref).style["height"] = this.touchH;
		document.getElementById("pot-touch-point-" + this.ref).style["top"] = this.touchH + fudgeY;
		document.getElementById("pot-touch-point-" + this.ref).style["left"] = this.touchW + fudgeX;
		//document.getElementById("pot-touch-point-" + this.ref).onclick = this.touchDown;
		
		document.getElementById("pot-" + this.ref + "-top").style["width"] = this.touchW;
		document.getElementById("pot-" + this.ref + "-top").style["height"] = this.touchH;
		document.getElementById("pot-" + this.ref + "-top").style["top"] = this.touchH  + fudgeY;
		document.getElementById("pot-" + this.ref + "-top").style["left"] = this.touchW + fudgeX;
		
		document.getElementById("pot-" + this.ref + "-marker").style["width"] = this.touchW;
		document.getElementById("pot-" + this.ref + "-marker").style["height"] = this.touchH;
		document.getElementById("pot-" + this.ref + "-marker").style["top"] = this.touchH  + fudgeY;
		document.getElementById("pot-" + this.ref + "-marker").style["left"] = this.touchW + fudgeX;
